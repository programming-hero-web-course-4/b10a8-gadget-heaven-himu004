  ...
  const handleCategoryClick = (category) => {
    ...
    if (category === "All") {
      ...
      if (filtered.length === 0) {
        setNotData("No data found in this category");
      } else {
        setNotData("");
      }
    }
      ...
      <div className="container mx-auto md:grid grid-cols-6 gap-4 pb-10">
        ...
        <div className="col-span-1 bg-white rounded-lg mb-5">
          <div className="flex flex-col h-[80vh]">
            <button
              ...
              className={`btn m-3 rounded-full ${
            ...
            <button
              ...
              className={`btn m-3 rounded-full ${
                selectedCategory === "Drones" ? "bg-[#9538E2] text-white" : ""
              }`}
            >
              Drones
            </button>
        ...
        <div className="col-span-5 grid md:grid-cols-3 gap-4">
          {filteredProducts.length > 0 ? (
            ...
            <p className="text-center text-2xl text-[#9538E2]">{notData}</p>
          )}
        </div>
      </div>
    </>
