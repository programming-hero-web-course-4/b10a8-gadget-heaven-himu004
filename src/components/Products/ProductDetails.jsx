  ...
  return (
    <div className="mb-28">
      <div className="bg-[#9538E2] h-56 text-center space-y-5 text-white">
        <p className="text-[2.5vw] font-bold">Product Details</p>
        <p className="max-w-md text-center mx-auto pb-5">
          Explore the latest gadgets that will take your experience to the next
          level. From smart devices to the coolest accessories, we have it all!
        </p>
      </div>
      <div className="max-w-5xl mx-auto flex gap-8 justify-center items-center bg-white rounded-xl p-14 space-y-5 -mt-16">
        <div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-5 pt-3">
            <button className="flex justify-center items-center gap-2 bg-[#9538E2] text-white px-5 py-2 rounded-full">
              Add to Cart
